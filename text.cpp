...
string get_rand_name(int i) {
    ...
    string surname[5] = { " Bush", " Trump", " Nikolaj", " Armstrong",
			  " Varoufakis" };
    int word, word1;
...
string get_rand_title(int i) {
    string title[6] = { "Laughing Name", "The Obsessed Dragon",
			"Sorcerer of Window", "The Slave's Destruction",
			"The Slave's Return", "The Abyss of the Flame" };
    int random;
